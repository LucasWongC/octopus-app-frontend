  ...
  return (
    <div className="flex items-center justify-between px-4 py-3 bg-white dark:bg-darkgrey-600 border-t border-gray-200 sm:px-6">
      <div className="flex-1 flex justify-between items-center sm:hidden">
        <button
          type="button"
          className="relative inline-flex items-center font-medium text-sm px-3 py-1 bg-white dark:bg-darkgrey-400 hover:bg-gray-50 border border-gray-300 text-gray-700 hover:text-gray-200 cursor-pointer disabled:cursor-not-allowed dark:text-white rounded-md"
          disabled={currentPage == 0}
          onClick={() => fetch(offset - limit)}
        >
          Previous
        </button>
        <div className="text-sm dark:text-white">Page {currentPage + 1}</div>
        <button
          type="button"
          className="relative inline-flex items-center font-medium text-sm px-3 py-1 bg-white dark:bg-darkgrey-400 hover:bg-gray-50 border border-gray-300 text-gray-700 hover:text-gray-200 cursor-pointer disabled:cursor-not-allowed dark:text-white rounded-md"
