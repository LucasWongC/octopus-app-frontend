          ...
          <div className="mt-1">
            ...
            >
              <div className="flex w-full flex-col pt-3 pb-1 pl-3 pr-2">
                <div className="w-full grid grid-cols-[1fr_auto] gap-4 items-end justify-between mb-1">
                  <input
                    role="textbox"
                    contentEditable="true"
                    inputMode="decimal"
                    className="w-[inherit] overflow-hidden box-content font-light leading-none whitespace-nowrap transition-[font-size,margin] ease-linear text-[60px] -mb-[3px] text-black focus-visible:outline-none"
      ...
      <div className="w-full bg-white rounded-2xl shadow-lg">
        <div className="flex flex-col p-2 w-full">
          ...
          <div className="mt-1">
            ...
            >
              <div className="flex w-full flex-col pt-3 pb-1 pl-3 pr-2">
                <div className="w-full grid grid-cols-[1fr_auto] items-end justify-between mb-1">
                  <input
                    role="textbox"
                    contentEditable="true"
                    inputMode="decimal"
